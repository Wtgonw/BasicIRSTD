...
# parser.add_argument("--model_names", default=['SCTransNet'], nargs='+', help="model_name: 'ACM', 'ALCNet', 'DNANet', 'ISNet', 'UIUNet', 'RDIAN', 'ISTDU-Net', 'U-Net', 'RISTDnet', 'SCTransNet'")
# parser.add_argument("--model_names", default=['ISTDU-Net'], nargs='+', help="model_name: 'ACM', 'ALCNet', 'DNANet', 'ISNet', 'UIUNet', 'RDIAN', 'ISTDU-Net', 'U-Net', 'RISTDnet', 'SCTransNet'")
parser.add_argument("--model_names", default=['UIUNet', 'ISTDU-Net'], nargs='+', help="model_name: 'ACM', 'ALCNet', 'DNANet', 'ISNet', 'UIUNet', 'RDIAN', 'ISTDU-Net', 'U-Net', 'RISTDnet', 'SCTransNet'")
...
# parser.add_argument("--pth_dirs", default=['WideIRSTD/SCTransNet_1.pth.tar'], nargs='+', help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
...
# parser.add_argument("--pth_dirs", default=['WideIRSTD/UIUNet_300.pth.tar', 'WideIRSTD/ISTDU-Net_150.pth.tar'], nargs='+', help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
parser.add_argument("--pth_dirs", default=['WideIRSTD/UIUNet_300.pth.tar', 'WideIRSTD/ISTDU-Net_150.pth.tar'], nargs='+', help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
parser.add_argument("--dataset_dir", default='./datasets', type=str, help="train_dataset_dir")
# parser.add_argument("--dataset_names", default=['NUAA-SIRST', 'NUDT-SIRST', 'IRSTD-1K'], nargs='+', help="dataset_name: 'NUAA-SIRST', 'NUDT-SIRST', 'IRSTD-1K', 'SIRST3', 'NUDT-SIRST-Sea'")
parser.add_argument("--dataset_names", default=['WideIRSTD'], nargs='+', help="dataset_name: 'NUAA-SIRST', 'NUDT-SIRST', 'IRSTD-1K', 'SIRST3', 'NUDT-SIRST-Sea'")
...
parser.add_argument("--img_norm_cfg_mean", default=None, type=float, help="specific a mean value img_norm_cfg, default=None (using img_norm_cfg values of each dataset)")
parser.add_argument("--img_norm_cfg_std", default=None, type=float, help="specific a std value img_norm_cfg, default=None (using img_norm_cfg values of each dataset)")
            ...
            if model_name == 'ISTDU-Net':
                ...
                if size[0] <= 2048 and size[1] <= 2048:
                    ...
                    for i in range(0, size[0], split_size):
                        ...
                        pred_combined = torch.cat(pred_cols, dim=3)
                        pred_rows.append(pred_combined)
    
                    pred = torch.cat(pred_rows, dim=2)
                    pred = pred[:, :, :size[0], :size[1]]
